...
if __name__ == "__main__":
    ...
    extra_parser.add_argument("--cot_version", type=str, default="no", choices=["no", "v1", "v2", "v3", "v3.2", "v4", "v5", "v6", "v6_sample", "vqa"],)
    ...
    extra_parser.add_argument("--lang_inject", type=str, default="no")
